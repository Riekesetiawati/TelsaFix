          ...
          <div class="col-6">
            ...
            <form method="POST" action="">
              <div class="col-12">
                ...
                <input type="text" class="cari" name="address" id="address" placeholder="Masukkan lokasi" required>
              </div>
              <div class="col-12">
               <center>
               <button type="submit" name="submit_address" class="btn btn-primary">Cari</button>
               </center>
              </div>
            </form>
